...
mongo_uri = os.getenv('MONGO_URI', 'mongodb+srv://subhadip03031996:N2yB66KsCNINytcI@chatbotdb.gtckekn.mongodb.net/?retryWrites=true&w=majority&appName=chatbotDb')
